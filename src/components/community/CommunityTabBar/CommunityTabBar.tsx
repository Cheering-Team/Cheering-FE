...
import {CommunityTabItem} from './CommunityTabItem';
import {Indicator} from './Indicator';

export const TABBAR_HEIGHT = 48;

const CommunityTabBar = <T extends TabName = TabName>({
  tabNames,
  indexDecimal,
  scrollEnabled = false,
  indicatorStyle,
...
const MemoizedTabBar = React.memo(CommunityTabBar);

export {MemoizedTabBar as CommunityTabBar};
