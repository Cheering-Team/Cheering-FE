...
import {useCommunityFeedFlatList} from './useCommunityFeedFlatList';
import ListEmpty from '../../common/ListEmpty/ListEmpty';

interface CommunityFeedFlatListProps {
...
const CommunityFeedFlatList = forwardRef<
  FlatList<any>,
  CommunityFeedFlatListProps
>((props, ref) => {
  const {
    playerData,
...
export default CommunityFeedFlatList;
